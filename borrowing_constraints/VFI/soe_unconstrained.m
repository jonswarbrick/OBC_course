%% Solves SOE model using Value Function Iteration
...
print(h,'VFI_policy_uncon','-r300','-depsc')
...
xlim([-0.2,0.2])
h.Position = [ 100 , 100 , 800 , 400 ];
print(h,'VFI_value_uncon','-r300','-depsc')
...
for t=2:time_horizon
    ...
    sim.b(t) =  interp2( repmat( z , b_pts , 1 ) , repmat( b' , 1 , z_pts ) , b_policy , sim.z(t) , sim.b(t-1) , 'spline' );
end
