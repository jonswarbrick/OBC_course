...
while err>tol
    ...
    theta22_0_ = normcdf( - mu2_cons ./ g_mu2u );
    
    % Check for convergence
    err = ( theta11_0_old - theta11_0_ )^2 + ( theta22_0_old - theta22_0_ )^2;
    disp(['Iteration: ',num2str(iter),' | error: ',num2str(err),' | p(1,1): ',num2str(theta11_0_),' | p(2,2): ',num2str(theta22_0_)])
